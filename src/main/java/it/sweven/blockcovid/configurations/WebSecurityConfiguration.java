...
/* Our own imports */
import it.sweven.blockcovid.configurations.NoRedirectStrategy;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    private static final RequestMatcher PUBLIC_URLS = new OrRequestMatcher(new AntPathRequestMatcher("/register"),
